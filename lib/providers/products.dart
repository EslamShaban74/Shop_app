...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://shop-93fa3-default-rtdb.firebaseio.com/products.json?auth=$authTok&$filteredString';
    ...
    try {
      ...
      url =
          'https://shop-93fa3-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth=$authTok';
  ...
  Future<void> addProduct(Product product) async {
    final url =
        'https://shop-93fa3-default-rtdb.firebaseio.com/products.json?auth=$authTok';
    try {
  ...
  Future<void> updateProduct(String id, Product newproduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          'https://shop-93fa3-default-rtdb.firebaseio.com/products/$id.json?auth=$authTok';
